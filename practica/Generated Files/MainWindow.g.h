...
namespace winrt::practica::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MainWindow_base : implements<D, practica::MainWindow, composing, I...>,
        ...
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        ...
        using class_type = practica::MainWindow;
...
namespace winrt::practica::factory_implementation
{
    ...
    {
        using instance_type = practica::MainWindow;
