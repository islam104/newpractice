...
namespace winrt::practica::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, practica::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = practica::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"practica.XamlMetaDataProvider";
        }
    };
}
namespace winrt::practica::factory_implementation
{
    ...
    {
        using instance_type = practica::XamlMetaDataProvider;
