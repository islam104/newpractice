...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"practica.MainWindow"))
    {
        return winrt_make_practica_MainWindow();
    }

    if (requal(name, L"practica.XamlMetaDataProvider"))
    {
        return winrt_make_practica_XamlMetaDataProvider();
    }
